...
import ***REMOVED*** Typography, TextField, Button, Fab ***REMOVED*** from '@material-ui/core';
import api from '../api';
import HSSnackbar from '../components/hs-snackbar';
import ***REMOVED*** enforceNotAuth ***REMOVED*** from '../utils/auth';
  ...
  ***REMOVED***
  return (
    ...
    <div className=***REMOVED***classes.root***REMOVED*** >
      ...
      >
        ***REMOVED***(***REMOVED***values, isSubmitting, handleChange, errors, touched, handleSubmit***REMOVED***) => ***REMOVED***
          return (
            <form onSubmit=***REMOVED***handleSubmit***REMOVED***>
              ...
              <TextField
                ...
                fullWidth
              />
              <Fab classes=***REMOVED******REMOVED***root: classes.signinButton***REMOVED******REMOVED*** type="submit" variant="extended" color="primary" disabled=***REMOVED***isSubmitting***REMOVED***>Sign In</Fab>
            </form>
          )
        ***REMOVED******REMOVED***
      </Formik>
...
Login.getInitialProps = function(ctx) ***REMOVED***
  enforceNotAuth(ctx);
